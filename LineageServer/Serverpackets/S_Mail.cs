    ...
    class S_Mail : ServerBasePacket
    {
        ...
        public S_Mail(L1PcInstance pc, int type)
        {
            ...
            for (int i = 0; i < mails.Count; i++)
            {
                ...
                WriteD((int)(mail.Date.Ticks / 1000));
                WriteC(mail.SenderName == pc.Name ? 1 : 0); // 寄件/備份
                WriteS(mail.SenderName == pc.Name ? mail.ReceiverName : mail.SenderName);
