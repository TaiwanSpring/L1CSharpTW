                ...
                if (mapIndex == 1)
                {
                    ...
                    { // 亞丁-村莊北邊地區
                      //X34079 Y33136 右下角 X 34090 Y 33150
                        locx = 34079 + (int)(RandomHelper.NextDouble() * 12);
                        locy = 33136 + (int)(RandomHelper.NextDouble() * 15);
                    }
                    else if (point == 1)
                    { // 亞丁-村莊中心地區
                      //左上角 X 33970 Y 33243 右下角 X33979 Y33256 
                        locx = 33970 + (int)(RandomHelper.NextDouble() * 10);
                        locy = 33243 + (int)(RandomHelper.NextDouble() * 14);
                    }
                    else if (point == 2)
                    { // 亞丁-村莊教堂地區
                      // 左上 X33925 Y33351 右下 X33938 Y33359
                        locx = 33925 + (int)(RandomHelper.NextDouble() * 14);
                        locy = 33351 + (int)(RandomHelper.NextDouble() * 9);
                    }
                }
                else if (mapIndex == 2)
                {
                    ...
                    { // 古魯丁-北邊地區
                      //左上 X32615 Y32719 右下 X32625 Y32725
                        locx = 32615 + (int)(RandomHelper.NextDouble() * 11);
                        locy = 32719 + (int)(RandomHelper.NextDouble() * 7);
                    }
                    else if (point == 1)
                    { // 古魯丁-南邊地區
                      //左上 X32621 Y32788 右下 X32629 Y32800  
                        locx = 32621 + (int)(RandomHelper.NextDouble() * 9);
                        locy = 32788 + (int)(RandomHelper.NextDouble() * 13);
                    }
                }
                else if (mapIndex == 3)
                {
                    ...
                    { // 奇岩-北邊地區
                      //左上 X33501 Y32765 右下 X33511 Y32773
                        locx = 33501 + (int)(RandomHelper.NextDouble() * 11);
                        locy = 32765 + (int)(RandomHelper.NextDouble() * 9);
                    }
                    else if (point == 1)
                    { // 奇岩-南邊地區
                      //左上 X33440 Y32784 右下 X33450 Y32794 
                        locx = 33440 + (int)(RandomHelper.NextDouble() * 11);
                        locy = 32784 + (int)(RandomHelper.NextDouble() * 11);
                    }
                }
