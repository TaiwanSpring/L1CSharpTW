...
{
    class CharacterElfWarehouse : DataSource
    {
        public const string TableName = "character_elf_warehouse";
        ...
        public override DataSourceTypeEnum DataSourceType { get { return DataSourceTypeEnum.CharacterElfWarehouse; } }
        ...
        public CharacterElfWarehouse() : base(TableName)
        {
