...
{
    class ClanWarehouse : DataSource
    {
        public const string TableName = "clan_warehouse";
        ...
        public override DataSourceTypeEnum DataSourceType { get { return DataSourceTypeEnum.ClanWarehouse; } }
        ...
        public ClanWarehouse() : base(TableName)
        {
