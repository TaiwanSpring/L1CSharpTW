...
namespace LineageServer.Server
{
    class GMCommands
    {
        ...
        private static IDictionary<int, string> _lastCommands = MapFactory.NewMap<int, string>();
        ...
        private bool ExecuteCommand(L1PcInstance pc, string name, string arg)
        {
            ...
            ILineageCommand commandExecutor = L1Commands.GetCommandExecutor(command.Name);
