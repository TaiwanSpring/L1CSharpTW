...
namespace LineageServer.Server.Model
{
    class L1World
    {
        ...
        private readonly IDictionary<int, GameObject> _allObjects;

        private readonly IDictionary<int, GameObject>[] _visibleObjects;
        ...
        private L1World()
        {
            _allPlayers = MapFactory.NewConcurrentMap<string, L1PcInstance>(); // 全てのプレイヤー
            _allPets = MapFactory.NewConcurrentMap<int, L1PetInstance>(); // 全てのペット
            _allSummons = MapFactory.NewConcurrentMap<int, L1SummonInstance>(); // 全てのサモンモンスター
            _allObjects = MapFactory.NewConcurrentMap<int, GameObject>(); // 全てのオブジェクト(L1ItemInstance入り、L1Inventoryはなし)
            _visibleObjects = new IDictionary<int, GameObject>[MAX_MAP_ID + 1]; // マップ毎のオブジェクト(L1Inventory入り、L1ItemInstanceはなし)
            _allWars = ListFactory.NewConcurrentList<L1War>(); // 全ての戦争
            _allClans = MapFactory.NewConcurrentMap<string, L1Clan>(); // 所有的血盟物件 (Online/Offline)
        ...
        public virtual void storeObject(GameObject l1Object)
        {
            if (l1Object == null)
            {
        ...
        public virtual void removeObject(GameObject l1Object)
        {
            if (l1Object == null)
            {
                throw new System.NullReferenceException();
        ...
        public virtual GameObject findObject(int oID)
        {
            return _allObjects[oID];
        }

        // _allObjectsのビュー
        private ICollection<GameObject> _allValues;

        public virtual ICollection<GameObject> Object
        {
            get
            {
                ICollection<GameObject> vs = _allValues;
        ...
        public virtual void addVisibleObject(GameObject l1Object)
        {
        ...
        public virtual void removeVisibleObject(GameObject l1Object)
        {
            if (l1Object.MapId <= MAX_MAP_ID)
            {
        ...
        public virtual void moveVisibleObject(GameObject l1Object, int newMap) // set_Mapで新しいMapにするまえに呼ぶこと
        {
        ...
        public virtual IList<GameObject> getVisibleLineObjects(GameObject src, GameObject target)
        {
        ...
        public virtual IList<GameObject> getVisibleBoxObjects(GameObject l1Object, int heading, int width, int height)
        {
            int x = l1Object.X;
            int y = l1Object.Y;
        ...
        public virtual IList<GameObject> getVisibleObjects(GameObject l1Object)
        {
        ...
        public virtual IList<GameObject> getVisiblePoint(L1Location loc, int radius)
        {
            IList<GameObject> result = ListFactory.NewList<GameObject>();
        ...
        public virtual IList<L1PcInstance> getVisiblePlayer(GameObject l1Object)
        {
            return getVisiblePlayer(l1Object, -1);
        }

        public virtual IList<L1PcInstance> getVisiblePlayer(GameObject l1Object, int radius)
        {
            int map = l1Object.MapId;
            Point pt = l1Object.Location;
        ...
        public virtual IList<L1PcInstance> getVisiblePlayerExceptTargetSight(GameObject l1Object, GameObject target)
        {
            int map = l1Object.MapId;
        ...
        /// <param name="object">
        /// @return </param>
        public virtual IList<L1PcInstance> getRecognizePlayer(GameObject l1Object)
        {
        ...
        public IDictionary<int, GameObject> AllVisibleObjects
        {
            get
            {
                return _allObjects;
        ...
        public IDictionary<int, GameObject>[] VisibleObjects
        {
            get
            {
