...
{
    public class L1NpcDefaultAction : IGameComponent, IGameActionProvider
    {
        class Action
        {
            public int defaultAttack = 1; // 預設攻擊
            public int specialAttack = 0; // 特殊攻擊
            public int rangedAttack = 1; // 遠距攻擊
            public int status = 0; // 狀態
        }

        private readonly IDictionary<int, Action> _dataMap = MapFactory.NewMap<int, Action>();
