...
namespace LineageServer.Server.Model.Game
{
    class L1PolyRace
    {
        ...
        //	進場等待--->確認人數
        private class ReadyTimer : Models.TimerTask
        {
        ...
        //	確認人數OK --->開始
        private class CheckTimer : Models.TimerTask
        {
            private readonly L1PolyRace outerInstance;
        ...
        //	倒數5秒--->開始計時
        private class ClockTimer : Models.TimerTask
        {
            private readonly L1PolyRace outerInstance;
        ...
        //	開始計時--->遊戲結束
        private class GameTimeLimitTimer : Models.TimerTask
        {
            private readonly L1PolyRace outerInstance;
        ...
        private class EndTimer : Models.TimerTask
        {
            private readonly L1PolyRace outerInstance;
        ...
        private class CompareTimer : Models.TimerTask
        {
            private readonly L1PolyRace outerInstance;
