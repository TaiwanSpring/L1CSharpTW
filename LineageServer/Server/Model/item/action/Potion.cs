...
namespace LineageServer.Server.Model.item.action
{
	...
	using S_CurseBlind = LineageServer.Serverpackets.S_CurseBlind;
	using S_ServerMessage = LineageServer.Serverpackets.S_ServerMessage;
	using S_Liquor = LineageServer.Serverpackets.S_Liquor;
	using S_SkillBrave = LineageServer.Serverpackets.S_SkillBrave;
	using S_SkillHaste = LineageServer.Serverpackets.S_SkillHaste;
	using S_SkillIconBlessOfEva = LineageServer.Serverpackets.S_SkillIconBlessOfEva;
	using S_SkillIconGFX = LineageServer.Serverpackets.S_SkillIconGFX;
	using S_SkillIconWisdomPotion = LineageServer.Serverpackets.S_SkillIconWisdomPotion;
