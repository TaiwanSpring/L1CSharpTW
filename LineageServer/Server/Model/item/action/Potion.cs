...
namespace LineageServer.Server.Model.item.Action
{
    class Potion
    {
        ...
        public static void ThirdSpeed(L1PcInstance pc, L1ItemInstance item, int time)
        {
            ...
            pc.setSkillEffect(L1SkillId.STATUS_THIRD_SPEED, time * 1000);
        ...
        public static void UseHeallingPotion(L1PcInstance pc, L1ItemInstance item, int healHp, int gfxid)
        {
            ...
            healHp = (int)((healHp * (RandomHelper.NextGaussian() / 5.0d)) + 1.0d);
        ...
        public static void useBluePotion(L1PcInstance pc, L1ItemInstance item, int item_id)
        {
            ...
            pc.setSkillEffect(L1SkillId.STATUS_BLUE_POTION, time * 1000);
            pc.Inventory.removeItem(item, 1);
        }
        ...
        public static void useWisdomPotion(L1PcInstance pc, L1ItemInstance item, int item_id)
        {
            ...
            {
                pc.killSkillEffectTimer(L1SkillId.STATUS_WISDOM_POTION);
            }
            ...
            pc.setSkillEffect(L1SkillId.STATUS_WISDOM_POTION, time * 1000);
            pc.Inventory.removeItem(item, 1);
        }
        ...
        public static void useBlessOfEva(L1PcInstance pc, L1ItemInstance item, int item_id)
        {
            ...
            { // 持續時間可累加
                int timeSec = pc.getSkillEffectTimeSec(L1SkillId.STATUS_UNDERWATER_BREATH);
                time += timeSec;
                if (time > 7200)
                {
                    time = 7200;
            ...
            pc.sendPackets(new S_SkillSound(pc.Id, 190));
            pc.broadcastPacket(new S_SkillSound(pc.Id, 190));
            pc.setSkillEffect(L1SkillId.STATUS_UNDERWATER_BREATH, time * 1000);
            pc.Inventory.removeItem(item, 1);
        }
        ...
        public static void useBlindPotion(L1PcInstance pc, L1ItemInstance item)
        {
            ...
            {
                pc.killSkillEffectTimer(L1SkillId.CURSE_BLIND);
            }
            else if (pc.hasSkillEffect(L1SkillId.DARKNESS))
            {
                pc.killSkillEffectTimer(L1SkillId.DARKNESS);
            }
            ...
            pc.setSkillEffect(L1SkillId.CURSE_BLIND, time * 1000);
            pc.Inventory.removeItem(item, 1);
        }
    }
