    ...
    class Effect
    {
        ...
        public static void deleteRepeatedSkills(L1PcInstance pc, int skillId)
        {
            int[][] repeatedSkills = new int[][]
               {
                new int[] {L1SkillId.EFFECT_POTION_OF_EXP_150, L1SkillId.EFFECT_POTION_OF_EXP_175, L1SkillId.EFFECT_POTION_OF_EXP_200, L1SkillId.EFFECT_POTION_OF_EXP_225, L1SkillId.EFFECT_POTION_OF_EXP_250, L1SkillId.EFFECT_POTION_OF_BATTLE },
                new int[] { L1SkillId.EFFECT_STRENGTHENING_HP, L1SkillId.EFFECT_STRENGTHENING_MP, L1SkillId.EFFECT_ENCHANTING_BATTLE },
