...
namespace LineageServer.Server.Model
{
    class L1Character : GameObject
    {
        ...
        public virtual byte MagicStoneLevel
        {
            get
            {
        ...
        public virtual void addDodge(int i)
        {
            _dodge = (byte)(_dodge + i);
            if (_dodge >= 10)
            {
                _dodge = 10;
            }
        ...
        public virtual void addNdodge(int i)
        {
            _nDodge = (byte)(_nDodge + i);
            if (_nDodge >= 10)
            {
                _nDodge = 10;
            }
