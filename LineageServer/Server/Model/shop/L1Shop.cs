...
namespace LineageServer.Server.Model.shop
{
    class L1Shop
    {
        ...
        {
            IList<L1AssessedItem> result = ListFactory.NewList<L1AssessedItem>();
        ...
        private void sellItems(L1PcInventory inv, L1ShopBuyOrderList orderList)
        {
            ...
            foreach (L1ShopBuyOrder order in orderList.List)
            {
                ...
                { // Race Tickets
                    ...
                    string[] runNum = item.Item.IdentifiedNameId.Split('-');
                    int trueNum = 0;
                    for (int i = 0; i < 5; i++)
                    {
        ...
        public virtual void sellItems(L1PcInstance pc, L1ShopBuyOrderList orderList)
        {
            ...
            sellItems(pc.Inventory as L1PcInventory, orderList);
            payTax(orderList);
        }
        ...
        {
            L1PcInventory inv = orderList.Pc.Inventory as L1PcInventory;
            int totalPrice = 0;
