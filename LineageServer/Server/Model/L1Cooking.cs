...
//	import static l1j.server.server.model.skill.L1SkillId.COOKING_WONDER_DRUG;
	...
	using S_MPUpdate = LineageServer.Serverpackets.S_MPUpdate;
	...
	public class L1Cooking
	{
		...
		public static void useCookingItem(L1PcInstance pc, L1ItemInstance item)
		{
			...
			{
				int cookingId = pc.CookingId;
				if (cookingId != 0)
				{
					pc.removeSkillEffect(L1SkillId.cookingId);
				}
			}
			...
			if ((itemId == 41284) || (itemId == 41292) || (itemId == 49056) || (itemId == 49064) || (itemId == 49251) || (itemId == 49259))
			{
				...
				if (dessertId != 0)
				{
					pc.removeSkillEffect(L1SkillId.dessertId);
				}
			}
		...
		public static void eatCooking(L1PcInstance pc, int cookingId, int time)
		{
			...
			if (((cookingId >= COOKING_1_0_N) && (cookingId <= COOKING_1_6_N)) || ((cookingId >= COOKING_1_0_S) && (cookingId <= COOKING_1_6_S)) || ((cookingId >= COOKING_2_0_N) && (cookingId <= COOKING_2_6_N)) || ((cookingId >= COOKING_2_0_S) && (cookingId <= COOKING_2_6_S)) || ((cookingId >= COOKING_3_0_N) && (cookingId <= COOKING_3_6_N)) || ((cookingId >= COOKING_3_0_S) && (cookingId <= COOKING_3_6_S)))
			{
