...
//	import static l1j.server.server.model.skill.L1SkillId.FOG_OF_SLEEPING;
	...
	using PetItemTable = LineageServer.Server.DataSources.PetItemTable;
	...
	using L1PetFood = LineageServer.Server.Model.L1PetFood;
	...
	using S_PetCtrlMenu = LineageServer.Serverpackets.S_PetCtrlMenu;
	using S_PetMenuPacket = LineageServer.Serverpackets.S_PetMenuPacket;
	using S_PetPack = LineageServer.Serverpackets.S_PetPack;
	...
	using S_SummonPack = LineageServer.Serverpackets.S_SummonPack;
	...
	public class L1PetInstance : L1NpcInstance
	{
		...
		private int actionType(string action)
		{
			...
			else if (action.Equals("getitem", StringComparison.OrdinalIgnoreCase))
			{ // 収集
				collect(false);
			}
			return status;
