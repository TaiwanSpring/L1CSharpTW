...
//	import static l1j.server.server.model.skill.L1SkillId.SHAPE_CHANGE;
	...
	using S_CloseList = LineageServer.Serverpackets.S_CloseList;
	...
	public class L1PolyMorph
	{
		...
		private static readonly IDictionary<int, int> weaponFlgMap = MapFactory.newMap();
		static L1PolyMorph()
		{
		...
		private static readonly IDictionary<int, int> armorFlgMap = MapFactory.newMap();
