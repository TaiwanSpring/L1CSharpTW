...
namespace LineageServer.Server.Model
{
    ...
    class L1PolyMorph
    {
        ...
        private static readonly IDictionary<int, int> weaponFlgMap = MapFactory.NewMap<int, int>();
        static L1PolyMorph()
        {
        ...
        private static readonly IDictionary<int, int> armorFlgMap = MapFactory.NewMap<int, int>();
        ...
        public static void doPolyPraivateShop(L1Character cha, int polyIndex)
        {
            ...
            if (cha is L1PcInstance)
            {
                ...
                if (pc.TempCharGfx != PolyList[polyIndex - 1])
                {
                    ...
                    (pc.Inventory as L1PcInventory).takeoffEquip(PolyList[polyIndex - 1]); // 是否將裝備的武器強制解除。
                }
