...
using LineageServer.Server.Server.Model.item;
...
namespace LineageServer.Server.Server.Clientpackets
{
    ...
    class C_ItemUSe : ClientBasePacket
    {
            ...
            if (pc.CurrentHp > 0)
            {
                ...
                { // 道具類
                    ...
                    { // マジックフルート
                        ...
                        foreach (L1Object visible in pc.KnownObjects)
                        {
                    ...
                    { // 閃電魔杖
                        int dmg = 0;
                        int[] data = null;
                        L1Object target = L1World.Instance.findObject(spellsc_objid);
                        if (target != null)
                        {
                    ...
                    { // 薪
                        foreach (L1Object @object in L1World.Instance.getVisibleObjects(pc, 3))
                        {
        ...
        private void makeCooking(L1PcInstance pc, int cookNo)
        {
            ...
            foreach (L1Object obj in L1World.Instance.getVisibleObjects(pc, 3))
            {
