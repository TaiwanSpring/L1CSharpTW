...
using LineageServer.Server.Server.Model.poison;
...
namespace LineageServer.Server.Server.Model
{
	...
	class L1Character : L1Object
	{
		...
		private readonly IDictionary<int, L1NpcInstance> _petlist = Maps.newMap<int, L1NpcInstance>();

		private readonly IDictionary<int, L1DollInstance> _dolllist = Maps.newMap<int, L1DollInstance>();

		private readonly IDictionary<int, IL1SkillTimer> _skillEffect = Maps.newMap<int, IL1SkillTimer>();

		private readonly IDictionary<int, L1ItemDelay.ItemDelayTimer> _itemdelay = Maps.newMap<int, L1ItemDelay.ItemDelayTimer>();

		private readonly IDictionary<int, L1FollowerInstance> _followerlist = Maps.newMap<int, L1FollowerInstance>();
		...
		private readonly IList<L1Object> _knownObjects = Lists.newConcurrentList<L1Object>();

		private readonly IList<L1PcInstance> _knownPlayer = Lists.newConcurrentList<L1PcInstance>();
		...
		public virtual bool knownsObject(L1Object obj)
		{
		...
		public virtual IList<L1Object> KnownObjects
		{
			get
			{
		...
		/// <param name="obj">
		///            新たに認識するオブジェクト。 </param>
		public virtual void addKnownObject(L1Object obj)
		{
		...
		/// <param name="obj">
		///            削除するオブジェクト。 </param>
		public virtual void removeKnownObject(L1Object obj)
		{
