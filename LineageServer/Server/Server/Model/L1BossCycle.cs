...
namespace LineageServer.Server.Server.Model
{
	...
	using BossSpawnTable = LineageServer.Server.Server.datatables.BossSpawnTable;
...
//ORIGINAL LINE: @XmlElement(name = "BossCycle") private java.util.List<L1BossCycle> bossCycles;
		...
		public static void load()
		{
			...
			{
				_log.log(Enum.Level.Server, "找不到BossCycle.xml的檔案位置。", e);
				Environment.Exit(0);
			}
		...
		private static IDictionary<string, L1BossCycle> _cycleMap = Maps.newMap();
