...
namespace LineageServer.Server.Server.Model
{
    ...
    class AcceleratorChecker
    {
        ...
        private int getRightInterval(ACT_TYPE type)
        {
            ...
            switch (type)
            {
                case LineageServer.Server.Server.Model.AcceleratorChecker.ACT_TYPE.ATTACK:
                    interval = SprTable.Instance.getAttackSpeed(_pc.TempCharGfx, _pc.CurrentWeapon + 1);
                    break;
                case LineageServer.Server.Server.Model.AcceleratorChecker.ACT_TYPE.MOVE:
                    interval = SprTable.Instance.getMoveSpeed(_pc.TempCharGfx, _pc.CurrentWeapon);
                    break;
                case LineageServer.Server.Server.Model.AcceleratorChecker.ACT_TYPE.SPELL_DIR:
                    interval = SprTable.Instance.getDirSpellSpeed(_pc.TempCharGfx);
                    break;
                case LineageServer.Server.Server.Model.AcceleratorChecker.ACT_TYPE.SPELL_NODIR:
