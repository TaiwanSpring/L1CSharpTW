...
namespace LineageServer.Server.Server.Model
{
	...
	using S_TradeAddItem = LineageServer.Server.Server.serverpackets.S_TradeAddItem;
	using S_TradeStatus = LineageServer.Server.Server.serverpackets.S_TradeStatus;
