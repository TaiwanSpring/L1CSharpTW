...
{
	using S_Board = LineageServer.Server.Server.serverpackets.S_Board;
	using S_BoardRead = LineageServer.Server.Server.serverpackets.S_BoardRead;
	using L1Npc = LineageServer.Server.Server.Templates.L1Npc;

	[Serializable]
	public class L1BoardInstance : L1NpcInstance
	{
		/// 
