...
namespace LineageServer.Server.Server.Model.Instance
{
    ...
    class L1PcInstance : L1Character
    {
        ...
        {
            foreach (L1Object known in KnownObjects)
            {
                if (known == null)
                {
                    continue;
        ...
        public virtual void updateObject()
        {
            ...
            if (MapId <= 10000)
            {
                foreach (L1Object visible in L1World.Instance.getVisibleObjects(this, Config.PC_RECOGNIZE_RANGE))
                {
            ...
            { // 旅館內判斷
                foreach (L1Object visible in L1World.Instance.getVisiblePlayer(this))
                {
                    if (!knownsObject(visible))
                    {
                        visible.onPerceive(this);
        ...
        private IList<int> skillList = Lists.newList<int>();
        ...
        public L1PcInstance()
        {
            ...
            _bookmarks = Lists.newList<L1BookMark>();
        ...
        private IList<L1PrivateShopSellList> _sellList = Lists.newList<L1PrivateShopSellList>();
        ...
        private IList<L1PrivateShopBuyList> _buyList = Lists.newList<L1PrivateShopBuyList>();
        ...
        { // 攻撃でＭＰを減らすときはここを使用
            if ((mpDamage > 0) && !Dead)
            {
                ...
                if ((attacker is L1PcInstance) && ((L1PcInstance)attacker).PinkName)
                {
                    ...
                    foreach (L1Object @object in L1World.Instance.getVisibleObjects(attacker))
                    {
        ...
        private void levelUp(int gap)
        {
            ...
            sendPackets(new S_OwnCharStatus(this));
            LineageServer.william._Level.getItem(this); //TODO　升級獎勵道具  by 阿傑
