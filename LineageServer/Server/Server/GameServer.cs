...
namespace LineageServer.Server.Server
{
	...
	using DropItemTable = LineageServer.Server.Server.DataSources.DropItemTable;
	...
	using GetBackRestartTable = LineageServer.Server.Server.DataSources.GetBackRestartTable;
	using InnTable = LineageServer.Server.Server.DataSources.InnTable;
	using IpTable = LineageServer.Server.Server.DataSources.IpTable;
	...
	using NpcActionTable = LineageServer.Server.Server.DataSources.NpcActionTable;
	using NpcChatTable = LineageServer.Server.Server.DataSources.NpcChatTable;
	using NpcSpawnTable = LineageServer.Server.Server.DataSources.NpcSpawnTable;
	...
	using ResolventTable = LineageServer.Server.Server.DataSources.ResolventTable;
	...
	using SpawnTable = LineageServer.Server.Server.DataSources.SpawnTable;
