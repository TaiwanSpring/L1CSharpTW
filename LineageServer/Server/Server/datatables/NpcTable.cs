...
namespace LineageServer.Server.Server.DataSources
{
    class NpcTable
    {
        ...
        private readonly IDictionary<int, L1Npc> _npcs = Maps.newMap<int, L1Npc>();
        ...
        private readonly IDictionary<string, System.Reflection.ConstructorInfo> _constructorCache = Maps.newMap<string, System.Reflection.ConstructorInfo>();
        ...
        public virtual L1NpcInstance newNpcInstance(L1Npc template)
        {
            ...
            {
                _log.log(Level.Server, e.Message, e);
            }
            return null;
        }
        ...
        {
            IDictionary<string, int> result = Maps.newMap<string, int>();
            IDataBaseConnection con = null;
            PreparedStatement pstm = null;
            ResultSet rs = null;
            try
