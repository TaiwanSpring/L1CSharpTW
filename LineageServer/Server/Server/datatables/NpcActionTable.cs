...
//ORIGINAL LINE: private NpcActionTable() throws Exception
		...
		public static void load()
		{
			...
			{
				_log.log(Enum.Level.Server, "找不到NpcAction讀取的位置。", e);
				Environment.Exit(0);
			}
		}
		...
		public virtual INpcAction get(string actionName, L1PcInstance pc, L1Object obj)
		{
		...
		public virtual INpcAction get(L1PcInstance pc, L1Object obj)
		{
