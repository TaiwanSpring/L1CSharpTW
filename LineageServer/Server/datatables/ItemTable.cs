...
{
    class ItemTable : IGameComponent
    {
        ...
        private IDictionary<int, L1EtcItem> _etcitems;

        private IDictionary<int, L1Armor> _armors;

        private IDictionary<int, L1Weapon> _weapons;
        ...
        private IDictionary<int, L1Weapon> allWeapon()
        {
            ...
            for (int i = 0; i < dataSourceRows.Count; i++)
            {
                ...
                weapon.set_addstr(dataSourceRow.getInt(Weapon.Column_add_str));
                weapon.set_adddex(dataSourceRow.getInt(Weapon.Column_add_dex));
                weapon.set_addcon(dataSourceRow.getInt(Weapon.Column_add_con));
                weapon.set_addint(dataSourceRow.getInt(Weapon.Column_add_int));
                weapon.set_addwis(dataSourceRow.getInt(Weapon.Column_add_wis));
                weapon.set_addcha(dataSourceRow.getInt(Weapon.Column_add_cha));
        ...
        private IDictionary<int, L1Armor> allArmor()
        {
            ...
            for (int i = 0; i < dataSourceRows.Count; i++)
            {
                ...
                if (dataSourceRow.HaveData)
                {
                    ...
                    armor.set_addstr(dataSourceRow.getInt(Armor.Column_add_str));
                    armor.set_adddex(dataSourceRow.getInt(Armor.Column_add_dex));
                    armor.set_addcon(dataSourceRow.getInt(Armor.Column_add_con));
                    armor.set_addint(dataSourceRow.getInt(Armor.Column_add_int));
                    armor.set_addwis(dataSourceRow.getInt(Armor.Column_add_wis));
                    armor.set_addcha(dataSourceRow.getInt(Armor.Column_add_cha));
