...
namespace LineageServer.Server
{
	...
	using ChatLogTable = LineageServer.Server.DataSources.ChatLogTable;
	using ClanTable = LineageServer.Server.DataSources.ClanTable;
	using DoorTable = LineageServer.Server.DataSources.DoorTable;
	using DropTable = LineageServer.Server.DataSources.DropTable;
	using DropItemTable = LineageServer.Server.DataSources.DropItemTable;
	using FurnitureItemTable = LineageServer.Server.DataSources.FurnitureItemTable;
	using FurnitureSpawnTable = LineageServer.Server.DataSources.FurnitureSpawnTable;
	using GetBackRestartTable = LineageServer.Server.DataSources.GetBackRestartTable;
	using InnTable = LineageServer.Server.DataSources.InnTable;
	using IpTable = LineageServer.Server.DataSources.IpTable;
	...
	using MailTable = LineageServer.Server.DataSources.MailTable;
	using MapsTable = LineageServer.Server.DataSources.MapsTable;
	using MobGroupTable = LineageServer.Server.DataSources.MobGroupTable;
	using NpcActionTable = LineageServer.Server.DataSources.NpcActionTable;
	using NpcChatTable = LineageServer.Server.DataSources.NpcChatTable;
	using NpcSpawnTable = LineageServer.Server.DataSources.NpcSpawnTable;
	...
	using PolyTable = LineageServer.Server.DataSources.PolyTable;
	using RaceTicketTable = LineageServer.Server.DataSources.RaceTicketTable;
	using ResolventTable = LineageServer.Server.DataSources.ResolventTable;
	using ShopTable = LineageServer.Server.DataSources.ShopTable;
	using SkillsTable = LineageServer.Server.DataSources.SkillsTable;
	using SpawnTable = LineageServer.Server.DataSources.SpawnTable;
	using SprTable = LineageServer.Server.DataSources.SprTable;
	using UBSpawnTable = LineageServer.Server.DataSources.UBSpawnTable;
	using WeaponSkillTable = LineageServer.Server.DataSources.WeaponSkillTable;
