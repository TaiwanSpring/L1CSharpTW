...
namespace ConsoleApp1
{
	class GameServer : IDisposable
	{
		...
		public GameServer(int listenPort, int maxClient)
		...
		public GameServer(IPEndPoint localEP, int maxClient)
		...
		/// <param name="listenPort">监听的端口</param>
		/// <param name="maxClient">最大客户端数量</param>
		public GameServer(IPAddress localIPAddress, int listenPort, int maxClient)
		{
