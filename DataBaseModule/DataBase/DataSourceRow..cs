...
{
    public class DataSourceRow : IDataSourceRow
    {
        ...
        //private readonly ColumnInfo[] columnInfos = new ColumnInfo[]
        //    {
        //        new ColumnInfo(){ Column="Col", IsPKey = true, DbType = DbType.Int32 },

        //        new ColumnInfo(){ Column="Name", IsPKey = false, DbType = DbType.String },

        //        new ColumnInfo(){ Column="Key2", IsPKey = true, DbType = DbType.Int32 },
        //    };
        ...
        {
            this.dbConnection = ModuleInfo.DbConnection;
